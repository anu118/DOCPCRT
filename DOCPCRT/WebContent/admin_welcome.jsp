...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="FacultyFeedbackAdmin.jsp">Feedback Feedback</a>
      </div>
    </li>
...
<h6><center><strong>Registered Users</center></strong></h6>
...
<td>
<a href="delete.jsp?id=<%=resultSet.getString("name") %>">
<a href="update.jsp?id=<%=resultSet.getString("name") %>">
