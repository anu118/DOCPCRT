...
String sql ="SELECT * FROM student_result_admin";
...
<td><%=resultSet.getString("a") %></td>
<td><%=resultSet.getString("c") %></td>
<td><%=resultSet.getString("w") %></td>
<td><%=resultSet.getString("m") %></td>
<td><%=resultSet.getString("t") %></td>
<td><%=resultSet.getString("p") %></td>
