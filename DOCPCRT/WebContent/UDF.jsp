...
<head>
<meta charset="UTF-8">
<title>Upload/Download Course</title>
</head>
...
<a href="Aptitude.pdf" download>Download Course File</a><br><br>
  ...
  <label for="password1"><b> Upload course</b></label><br><br>
  <input type="file" name="fileToUpload" id="fileToUpload">
  <button input type="submit" name="submit" class="registerbtn" value="register">Upload</button>
