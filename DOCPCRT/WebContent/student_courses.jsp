...
<h5><center><strong>Welcome Admin</strong></center></h5>
...
<ul class="navbar-nav ml-auto">
    ...
    <li aria-current="true" class="nav-item">    
      <a class="nav-link" href="admin_welcome.jsp">Home</a>
      </li>
...
<h6><center><strong>Student Courses</center></strong></h6>
...
<td><%=resultSet.getString("s_cid") %></td>
<td><%=resultSet.getString("s_cname") %></td>
<td><%=resultSet.getString("s_cdesc") %></td>
<td><%=resultSet.getString("s_cfilesdownload") %></td>


<td>
<a href="delete.jsp?id=<%=resultSet.getString("s_name") %>">
<a href="update.jsp?id=<%=resultSet.getString("s_name") %>">
