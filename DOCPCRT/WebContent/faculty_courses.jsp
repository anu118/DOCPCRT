...
<h6><center><strong>Faculty Courses</center></strong></h6>
...
String sql ="SELECT * FROM faculty_course";
...
<td>
<a href="delete.jsp?id=<%=resultSet.getString("f_name") %>">
<a href="update.jsp?id=<%=resultSet.getString("f_name") %>">
